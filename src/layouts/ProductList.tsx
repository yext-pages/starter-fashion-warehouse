...
import Paragraph from "../components/atoms/StyledText";
import PublicImage from "../components/atoms/PublicImage";
import StudioImage, { StudioImageProps } from "../components/atoms/StudioImage";
